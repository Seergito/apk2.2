...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sc=new SimpleCursorAdapter(MainActivity.this,R.layout.itemlistview,c,cols,controles,0);
        lv.setAdapter(sc);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        }else if (requestCode==PETICION_INSERT && resultCode==RESULT_CANCELED){Toast.makeText(this, "DATOS NO INSERTADOS", Toast.LENGTH_SHORT).show();}
        ...
        }else if(requestCode==PETICION_ACTUALIZAR && resultCode==RESULT_CANCELED){Toast.makeText(this, "DATOS NO ACTUALIZADOS", Toast.LENGTH_SHORT).show();}
    }
